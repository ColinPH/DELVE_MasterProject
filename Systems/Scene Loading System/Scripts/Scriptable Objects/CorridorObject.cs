...
{
    [Serializable]
    [CreateAssetMenu(fileName = "Data", menuName = "Scriptable Objects/Loadable/Corridor Object", order = 1)]
    public class CorridorObject : LoadableObject
    {
        public string corridorName = "Default Corridor Name";
        public Corridor corridorType = Corridor.Unassigned;
        ...
        public override string LoadableName => corridorName;
        public override object SceneIdentifier => corridorType;
        public override SceneGroup SceneGroup => SceneGroup.Corridor;
